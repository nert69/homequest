...
export default function RoomDetail({ theme, matText75, roomDetail: rd, onBack, onRename, onDelete }) {
  return (
    <div>
      ...
      <div style={{ position: 'sticky', top: 0, zIndex: 95, marginLeft: -16, marginRight: -16, marginBottom: 14, background: theme.cream, borderRadius: '0 0 22px 22px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 8, padding: '10px 16px 12px' }}>
